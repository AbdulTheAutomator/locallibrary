...
class Genre(models.Model):
    ...
    def __str__(self):
        ...
        #returns name of the genre of a record
        return self.name

    def get_absolute_url(self):
        """Returns the url to access a particular genre instance."""
        # url that can be used for accessing record. need to create url mapping with genre-detail
        return reverse('genre-detail', args=[str(self.id)])

    class Meta:
        #lower case of name field must be unique otherwise show exception message
        constraints = [
            UniqueConstraint(
                Lower('name'), 
